...
import { XIcon } from "@serverComponents/icons";
      ...
      <Tooltip.Trigger asChild>
        ...
        >
          ...
          <div className="flex flex-col items-start overflow-hidden">
            ...
            {valid ? (
              <span className="text-ellipsis text-xs opacity-80">
                <I18n i18nKey="verified" namespace="accounts" />{" "}
                {verifiedAt && moment(timestampDate(verifiedAt)).fromNow()}
              </span>
            ) : (
              verifiedAt && (
                <span className="text-ellipsis text-xs opacity-80">
                  <I18n i18nKey="expired" namespace="accounts" />{" "}
          ...
          <div className="relative flex flex-row items-center">
            ...
            >
              <XIcon className="h-5 w-5 opacity-50 transition-all hover:opacity-100 group-hover:block sm:hidden" />
            </span>
          </div>
        </button>
      </Tooltip.Trigger>
