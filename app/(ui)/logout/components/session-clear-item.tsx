  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-row items-center">
        <div className="mr-6 flex items-center justify-center rounded-full bg-[#ff0000]/10 px-2 py-[2px] text-xs text-warn-light-500 transition-all group-hover:block dark:bg-[#ff0000]/10 dark:text-warn-dark-500">
          <I18n i18nKey="clear" namespace="logout" />
        </div>
