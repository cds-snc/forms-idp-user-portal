...
import { Avatar, getInitials } from "../components/serverComponents/UserAvatar/Avatar";
...
describe("Avatar Component", () => {
  ...
  describe("Component Rendering", () => {
    ...
    it("should render with shadow prop", () => {
      const { container } = render(
        <Avatar name="Test User" loginName="test@example.com" shadow={true} />
      );
      expect(container.firstChild).toBeTruthy();
    });
    ...
    it("should render without shadow prop", () => {
      const { container } = render(
        <Avatar name="Test User" loginName="test@example.com" shadow={false} />
      );
      expect(container.firstChild).toBeTruthy();
    });
  ...
  describe("Theme Integration", () => {
    ...
    it("should respect theme roundness changes", () => {
      ...
      const { container: container1 } = render(
        <Avatar name="Test User" loginName="test1@example.com" />
      );
      ...
      const { container: container2 } = render(
        <Avatar name="Test User" loginName="test2@example.com" />
      );
  ...
  describe("Color Generation", () => {
    ...
    it("should render for different loginNames", () => {
      const { container: container1 } = render(
        <Avatar name="User 1" loginName="user1@example.com" />
      );
      const { container: container2 } = render(
        <Avatar name="User 2" loginName="user2@example.com" />
      );
